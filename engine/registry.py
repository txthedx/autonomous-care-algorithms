...
_REGISTRY: tuple[_Entry, ...] = (
    ...
    _Entry("geneva", "PE — revised Geneva score",
           "conditions.pulmonary_embolism", "geneva_assessment",
           ("pulmonary embolism", "dyspnea", "chest pain"), ("GenevaFeatures",)),
    ...
    _Entry("qsofa", "Sepsis — qSOFA", "conditions.sepsis", "qsofa_assessment",
           ("sepsis", "suspected infection", "fever"), ("QsofaFeatures",)),
    _Entry("westley_croup", "Croup — Westley Croup Score", "conditions.croup",
           "westley_assessment", ("croup", "stridor", "pediatric"),
           ("WestleyFeatures",)),
    _Entry("news2", "Early warning — NEWS2", "conditions.early_warning",
           "news2_assessment", ("deterioration", "early warning", "sepsis"),
           ("NewsFeatures",)),
)
